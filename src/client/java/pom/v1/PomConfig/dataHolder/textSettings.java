...
public class textSettings {
    ...
    public PomConfig.Property<Integer> size;
    ...
    public textSettings(
            ...
            PomConfig.Property<Integer> size) {
        this.active = active;
        this.c1 = c1;
        this.c2 = c2;
        this.y = y;
    ...
    public static textSettings performanceDisplay() {
        return new textSettings(
                new PomConfig.Property<>(false),
                new PomConfig.Property<>(Color.red),
                new PomConfig.Property<>(Color.red),
                new PomConfig.Property<>(1),
                new PomConfig.Property<>(1),
                new PomConfig.Property<>(75)
        );
    }
}
