...
public class PomGui {
    ...
    private static PomConfig Config = PomConfig.HANDLER.instance();
    ...
    public static Screen createScreen(Screen parent) {
        ...
        var islandCat = OptionGroup.createBuilder().name(Component.literal("Enabled Islands"));

        PomIslandData.getIslands().forEach((key, value) -> {
            Config.islandEnabled.putIfAbsent(key, value);
            islandCat.option(Option.<Boolean>createBuilder()
        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .build())
                .category(ConfigCategory.createBuilder()
                        .name(Component.literal("Enabled islands"))
                        .group(islandCat.build())
                        .build())
                .category(ConfigCategory.createBuilder()
